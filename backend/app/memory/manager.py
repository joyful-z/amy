...
logger = logging.getLogger("amy.memory.manager")

CORE_MEMORY_MESSAGE_NAME = "amy_core_memory"
MEMORY_INDEX_MESSAGE_NAME = "amy_memory_index"
MEMORY_POLICY_MESSAGE_NAME = "amy_memory_policy"
