...
_PATTERN_MINING_PROMPT = """You are Amy's Completed Task Pattern Miner.
...
_DISTILLATION_PROMPT = """You are Amy's Procedure Distiller.
...
_RELEVANCE_PROMPT = """You are Amy's Skill Relevance Selector.
...
_OVERLAP_ADJUDICATION_PROMPT = """You are Amy's Skill Overlap Adjudicator.
