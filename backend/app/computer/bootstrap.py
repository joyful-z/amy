...
logger = logging.getLogger("amy.computer.bootstrap")
...
ENV_HELPER_PATH = "AMY_MACOS_HELPER_PATH"
ENV_COMPUTER_ENABLED = "AMY_COMPUTER_ENABLED"
...
def computer_enabled(enabled: bool | None = None) -> bool:
    """Computer 开关：显式参数 > AMY_COMPUTER_ENABLED > 默认启用。
