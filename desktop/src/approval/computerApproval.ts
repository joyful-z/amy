...
/** Sandbox 审批：作用于 Amy 沙盒 / 宿主，永远进 Chat。 */
...
const ACTION_DESCRIPTIONS: Record<string, string> = {
  computer_click: 'Amy 准备点击当前应用中的界面元素。',
  computer_type: 'Amy 准备向当前应用输入下面的文本。',
  computer_key: 'Amy 准备向当前应用发送按键或快捷键。',
  computer_scroll: 'Amy 准备滚动当前应用窗口。',
  computer_open_app: 'Amy 准备打开一个应用。',
  computer_focus_window: 'Amy 准备切换到目标应用窗口。',
}
